...
*Make sure the values set for ![image](https://user-images.githubusercontent.com/56465665/66978876-46fbb480-f0f7-11e9-9bf6-f49fcfbe1a47.png) and databasename to the values from the "Databases tab". Change the password to the one 
that you set.*
